...
public class Task2Test {
  ...
  @Test
  void listAdd2TestExceptions() {
    MyList testList = new MyList();
    for (int i = 0; i < 11; i++) {
      testList.add(i);
    }
    Assertions.assertThrows(NullPointerException.class, () -> testList.add(5, null));
    Assertions.assertThrows(IndexOutOfBoundsException.class, () -> testList.add(99, 4));
  }
  ...
  void listException() {
    ...
    Assertions.assertThrows(UnsupportedOperationException.class,
        () -> testList.addAll(1, testList));
    Assertions.assertThrows(UnsupportedOperationException.class,
        () -> testList.removeAll(testList));
    Assertions.assertThrows(UnsupportedOperationException.class,
        () -> testList.retainAll(testList));
